...
IF  OBJECT_ID(N'[COWE].[BatchIntervals]',N'U') IS NOT NULL
  DROP TABLE [COWE].[BatchIntervals];
GO
...
CREATE TABLE [COWE].[BatchIntervals](
...
ALTER TABLE [COWE].[BatchIntervals] ADD CONSTRAINT [FK_CaptureBatch$CaptureBatchId] FOREIGN KEY (CaptureBatchId) REFERENCES [COWE].[CaptureBatch] (CaptureBatchId);
GO
