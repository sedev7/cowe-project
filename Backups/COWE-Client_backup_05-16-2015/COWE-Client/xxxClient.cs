 ...
 * v4 05-06-2015:
 *  i Add data layer.
 *  i Add analysis subsystem. 
 *  x Add controls to start/stop ParseCaptureFiles service.
 *  x Reorganize the UI.
 *  
 * v3:
 *  x Clean out old code
 *  x Add timer flooder for run-time.
 *  
 * TO DO:
...
namespace COWE.Client
{
    public partial class Client : Form
    {
        ...
        private void UpdateParseFilesServiceStatus()
        {
            ...
            switch(controller.Status)
            {
                case ServiceControllerStatus.Running:
                    ParseFilesServiceStatusLabel.Text = "Running";
                    break;
                case ServiceControllerStatus.Stopped:
                    ParseFilesServiceStatusLabel.Text = "Stopped";
                    break;
                case ServiceControllerStatus.ContinuePending:
                    ParseFilesServiceStatusLabel.Text = "Continue Pending";
                    break;
                case ServiceControllerStatus.Paused:
                    ParseFilesServiceStatusLabel.Text = "Paused";
                    break;
                case ServiceControllerStatus.PausePending:
                    ParseFilesServiceStatusLabel.Text = "Pause Pending";
                    break;
                case ServiceControllerStatus.StartPending:
                    ParseFilesServiceStatusLabel.Text = "Start Pending";
                    break;
                case ServiceControllerStatus.StopPending:
                    ParseFilesServiceStatusLabel.Text = "Stop Pending";
                    break;
                default:
                    ParseFilesServiceStatusLabel.Text = "Unknown";
                    break;
            }
        }
